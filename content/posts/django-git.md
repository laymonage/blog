...
date = 2020-06-03T08:52:43+07:00
tags = ["django", "git"]
toc = false
comments = true
draft = false
...
images = ["/images/uploads/django+git.png"]
+++

{{< figure src="/images/uploads/django+git.png"
caption="The web framework for perfectionists with deadlines, and *the* version control system." >}}
...
{{< figure src="/images/uploads/triage_process.svg"
width="75"
caption="The triage process."
attr="(Django docs)"
attrlink="https://docs.djangoproject.com/en/dev/internals/contributing/triaging-tickets/#how-can-i-help-with-triaging" >}}
